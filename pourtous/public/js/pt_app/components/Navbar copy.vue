<template>
  <nav>
    <v-app-bar app height="40" class="elevation-2">
      ...
      ></v-app-bar-nav-icon>
      <v-img
        src="/assets/pourtous/js/pt_app/components/pourtous/AvSymbol.jpg"
        alt="Pour Tous"
        max-width="32"
        class="mr-2"
        color="primary"
      ...
      >
        <span class="font-weight-light">pour</span>
        <span>tous</span>
      </v-toolbar-title>
...
export default {
  ...
  data() {
    return {
      ...
      mini: true,
      item: 0,
      items: [{ text: 'PO', icon: 'mdi-invoice-text-plus-outline' }],
      page: '',
      fav: true,
      menu: false,
      message: false,
  ...
  methods: {
    ...
    go_about() {
      const win = window.open(
        'https://github.com/karanwilson/AV-PourTous/tree/version-14',
        '_blank'
      );
      win.focus();
    },

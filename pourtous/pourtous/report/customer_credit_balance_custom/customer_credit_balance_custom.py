...
def get_columns(customer_naming_type):
	columns = [
		...
		_("FS Account") + ":Data:120",
		_("Credit Limit") + ":Currency:120",
		_("Outstanding Amt") + ":Currency:120",
...
def get_details(filters):
	sql_query = """SELECT
						c.name, c.customer_name, c.custom_fs_account_number,
	...
	if filters.get("custom_fs_account_number"):
		sql_query += " AND c.custom_fs_account_number = %(custom_fs_account_number)s"

frappe.listview_settings['Purchase Invoice'] = {
    refresh(listview) {
        ...
        // listview.page.add_inner_button("Remove duplicate ERP bills in ZB", () => {
        //     frappe.call({
        //         method: 'pourtous.pourtous.doctype.zoho_books_api.zoho_books_api.fetch_erp_bills_to_delete',
        //         async: false,
        //         callback: (r) => {
        //             if (r.message) {
        //                 const length = r.message.length;
        //                 console.log("Number of Bills to delete: ", length);
		// 				console.log("Bills List: ", r.message);
        //                 // console.log("r.message[0]['name']: ", r.message[0]["name"]);
        //                 let deleted = 0;
        //                 for (let i = 0; i < length; i++) {
        //                     setTimeout(() => {
        //                         frappe.call({
        //                             method: 'pourtous.pourtous.doctype.zoho_books_api.zoho_books_api.delete_duplicate_erp_bill_debitnote_in_zoho',
        //                             args: {
        //                                 bill: r.message[i]["name"]
        //                             },
        //                             async: false,
        //                         }).then(r => {
        //                             deleted += parseInt(r.message);
        //                         }).then(r => {
        //                             // placing this statement block here as it does not work outside of the main frappe.call block
        //                             // though it prints on console for each loop iteration (comes in only one line, with the loop count),
        //                             // it shows an accurate result in the end. This design works.
        ...
        //                         frappe.show_progress("Deleting Duplicate Bills in Zoho Books", count, length, message);
        //                     }, 0);
        //                 }
        //             }
        //         }
